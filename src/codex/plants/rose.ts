  ...
  species: [
    ...
    // ── 한국 육성 정원장미 ───────────────────────────────────
    {
      ...
      varieties: [
        ...
        { id: 'rosa-kr-everrose', name: '에버로즈(에버랜드)', trait: "에버랜드(삼성물산 리조트부문)가 2013년 장미축제 30주년을 계기로 시작한 한국 정원장미 브랜드다 — 단일 품종이 아니라 약 40품종을 묶는 이름이며, 국립종자원에는 코드명(이알001~034)으로 33품종이 등록됐다(공개 자료엔 마케팅 이름과 등록번호의 연결이 없다). 육종가 하호수 등이 2만 회 넘는 인공교배로 만들었고 노지 정원용 묘목으로 보급된다. ★이름이 공개된 개별 품종은 — 향기 품종군: 로지 브라이드·떼떼 드 벨르·채티 걸·포쉬 레이데·스위트 드레스(오전·오후 내내 향이 강하게 지속), 저관리 정원장미 에버스케이프 시리즈: 퍼퓸·가든·카니발, 그 밖에 틸라이트·레몬 버블·레이크드림·핑크 페이스트리 등 12품종이다(나머지 이름은 아직 공개되지 않았다). ★'한국 기후에 맞춰 내한·내병·저관리로 육종했다'고 알려졌으나 내한 온도·병 저항 등급 같은 수치는 공개되지 않았으니, 재배는 일반 정원장미 기준을 따른다. 네덜란드 절화 'Ever Red'·덴마크 분화 'Evera'와는 다른 장미다." },
        ...
        { id: 'rosa-kr-pink-pastry', name: '핑크 페이스트리', trait: "에버로즈의 또 다른 대표 품종이다. 분홍빛 정원장미로 꽃잎이 100여 장에 이르는 풍성한 겹꽃이며 달콤하고 시원한 향이 난다. 2014년부터 5년간 육성했고, 2025년 일본 기후세계장미대회에서 종합 동상과 향기 최고상(로즈 힐 어워드)을 받아 2관왕에 올랐다." },
      ],
